...
for lr in lrs:
    ...
    for i in range(MODEL_PARAMETERS['amount_of_worker']):
        ...
        path = "models/" + str(seed) + "/model_from_Worker-" + str(i) + "_" + str(MODEL_PARAMETERS['dataset']) + "_" + str(
    ...
    all_predictions, right_predictions, wrong_predictions, calibration = ens_model.test_model(validation_set, MODEL_PARAMETERS['prediction_number'])
