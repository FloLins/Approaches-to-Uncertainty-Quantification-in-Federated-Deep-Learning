...
def run_main():
    ...
    if CONTROLL_PARAMETERS['plotting']:
        plots.plot_entropy_and_variance(in_data["entropy"], right_wrong["entropy_right"], right_wrong["entropy_wrong"], ood_data["entropy"], in_data["variance"], ood_data["variance"], "Federated Training with Multiple Coordinators Fixed Association")
        plots.plot_calibration_curve(calibration['curve_label'], calibration['softmax_pred'], "Federated Training with Multiple Coordinators Fixed Association")
